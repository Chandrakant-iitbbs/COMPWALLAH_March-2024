    ...
    return (
        <div className={styles.skillsContainer} id="skills">
            <div className={styles.skillsSection}>
                ...
                <div className={styles.skillsDescription}>I love building <span>Full stack applications</span>, and participating in <span>competitive programming</span>.<br />I have experience with these technologies.</div>
